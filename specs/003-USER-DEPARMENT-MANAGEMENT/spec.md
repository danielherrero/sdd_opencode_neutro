...
- **RF-010: Cardinalidad de Usuario**: Cuando el sistema gestione las asociaciones, debera permitir que un usuario tenga cero, una o multiples asociaciones con departamentos, sin limitar el numero de departamentos asociados.
